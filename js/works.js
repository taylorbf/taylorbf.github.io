  		...
  		var DanceGlitch = [
			...
			{	name: "human", 
				year: "2010",
				month: "1",
				thumb: "images/100human.png",
				urltype: "web",
				url: "../slowvids/human.html", 
				comment: "20 sec slow motion movement",
				medium: "web, dance",
				hashtag: "human",
				grouptitle: "Old dance clips",
				groupdesc: "short videos of dancer Catherine Reiser, some slow, some glitchy, from 2009-2010 opal church sessions",
				grouptags: "web, dance"			
			},
	
			{
				...
				year: "2010",
				month: "2",
				thumb: "images/100glitchdance.png", 
				urltype: "web",
				url: "../slowvids/glitch5.html", 
				comment: "html5 video glitching. may not work in all browsers.",
				medium: "web, dance",
				hashtag: "glitch5"
			},
  		...
  		var Dreams9to14 = [
	...
	
			{
				...
				comment: "This is what I feel like in an empty house",
				medium: "web",
				hashtag: "roompoem"
			},
	...
	
			{
				...
				comment: "Your mouse can make art too",
				medium: "web",
				hashtag: "mouse"
			}
		];
  		...
  		var Fall2011js = [
			...
			{	name: "The Goldberg Variations Variations", 
				...
				comment: "glitching quicktime audio of bach",
				medium: "web, music",
				hashtag: "goldberg",
		...
		var Dream6 = [
			...
			{	name: "Dream6", 
				...
				comment: "composed by the dream6 instrument",
				medium: "music, maxmsp",
			...
			{	name: "for Kevin", 
				year: "2011",
				month: "12",
				thumb: "images/100kevin.png", 
				urltype: "web",
				url: 'http://www.whitechord.org/kevin/kevin.html', 
				comment: "web score for an acoustic work",
		...
		var Dreams = [
			...
			{	name: "scrollers", 
				...
				comment: "grid of miniature websites that are scrolling up and down.",
		...
		var WebPerformance = [
			...
			{	name: "whitechord", 
				...
				comment: "a 12-minute collage of my own musical websites with other sites on the web.",
	...
	
			{
				...
				comment: "sound from a performance of web collage.",
				medium: "web performance",
				hashtag: "tns2"
			},
	
			{
				...
				year: "2010",
				month: "5",
				thumb: "images/100opalchurch.png", 
				urltype: "soundcloud",
				...
				comment: "a performance where i use AJAX and max/msp to update a website in real-time.",
				medium: "web",
				hashtag: "relaygreen"
			},
		...
		var SiteSpecific = [
	...
	
			{
				...
				year: "2006",
				month: "10",
				thumb: "images/100racquetball.png", 
				urltype: "soundcloud",
				...
				comment: "chamber music in a racquetball court.",
				medium: "music",
				hashtag: "racquetball"
			},
		...
		var Instruments = [
			...
			{	name: "partch's lattice", 
				year: "2009",
				month: "12",
				thumb: "images/100partch.png", 
				urltype: "image",
				url: "images/partchlattice.png", 
				comment: "synthesizer for harry partch's 43-note scale.",
				medium: "maxmsp",
				hashtag: "partch",
	...
	
			{
				...
				year: "2010",
				month: "6",
				thumb: "images/100tonebox.png", 
				urltype: "image",
				url: "images/vessel-6.jpg", 
				comment: "long-string instrument with homemade electro-magnetic string resonator.",
				medium: "circuit",
				hashtag: "tonebox"
			},
